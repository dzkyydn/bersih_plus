...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    bersihPlusAuthUserSubject.add(
      BersihPlusAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BersihPlusAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BersihPlusAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BersihPlusAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    bersihPlusAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
BersihPlusAuthUser? currentUser;
